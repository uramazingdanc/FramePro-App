          ...
          <div className="bg-blue-50 p-3 rounded-lg max-w-xl">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-framepro-darkgray">
                <span className="font-medium">Portal Method Analysis:</span> Girder moments are calculated using column moments from the current floor and the floor directly above. Girder shears are calculated by adding left and right moments and dividing by the span length (Vgirder = (Mleft + Mright) / Lspan).
